    ...
    <div className="flex">
      ...
      <div className="flex-1 px-6 py-8 max-w-6xl">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-8">
            {[
              ...
              <Link
                key={label}
                to={to}
                className="bg-white border border-slate-200 rounded-xl p-5 hover:border-accent hover:shadow-sm transition"
              >
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/vehicles/search" className="text-sm text-accent font-medium hover:underline">
            See all →
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white border border-dashed border-slate-300 rounded-2xl">
            ...
            <h3 className="font-semibold text-slate-800 mb-1">No vehicles yet</h3>
