...
export default function CreateOrg() {
  ...
  const [form, setForm] = useState({
    name: "", type: "residency", size: "medium", description: "", location: "",
  });
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold mb-2">Create a new pooling community</h1>
      ...
      <form onSubmit={submit} className="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
              className="w-full border border-slate-300 rounded-md pl-9 pr-3 py-2" placeholder="e.g. ABC Residency Pooling" />
          </div>
        </div>
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Community size</label>
            <div className="relative">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input value={form.location} onChange={(e) => setForm({ ...form, location: e.target.value })}
              className="w-full border border-slate-300 rounded-md pl-9 pr-3 py-2" placeholder="City / area" />
          </div>
        </div>
        <div>
          ...
          <div className="relative">
            ...
            <textarea value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })}
              className="w-full border border-slate-300 rounded-md pl-9 pr-3 py-2" rows={3} />
          </div>
        </div>
