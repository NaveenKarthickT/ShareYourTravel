...
export default function CreateOrg() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold mb-2 text-primary dark:text-sky-300">Create a new pooling community</h1>
      <p className="text-slate-600 dark:text-slate-400 mb-6">This creates an independent pooling server with its own users, admin and trips.</p>
      <form onSubmit={submit} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-6 space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1 text-slate-700 dark:text-slate-300">Community name</label>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-slate-700 dark:text-slate-300">Size</label>
            <div className="relative">
