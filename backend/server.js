...
app.get("/api/health", (req, res) =>
  res.json({ success: true, status: "ok", db: dbReady })
);
...
// Auto-complete expired trips every 5 minutes (skipped on Vercel)
...
const autoCompleteExpiredTrips = async () => {
  try {
    ...
    console.error("autoCompleteExpiredTrips:", err.message);
  }
};
